        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsSolutionPreviouslyDiscussed = table.Column<bool>(type: "bit", nullable: false),
                    CorrectionFactor = table.Column<float>(type: "real", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PlannedSavings = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    PlannedExpenses = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    PlannedBalance = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ActualSavings = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsAssociateResponsible = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ideas_AspNetUsers_AssociateId",
